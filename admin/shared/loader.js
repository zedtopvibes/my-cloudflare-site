...
async function loadSharedComponents() {
    ...
    // By the time we reach here, ALL HTML is fully loaded (because await finished)
    // No timers needed. No event delegation. Just direct attachment.
    const allToggles = document.querySelectorAll('.nav-dropdown-toggle');
    allToggles.forEach(toggle => {
        // Remove any existing listeners to avoid duplicates (clean slate)
